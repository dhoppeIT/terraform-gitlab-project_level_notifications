...
| <a name="input_level"></a> [level](#input\_level) | The level of the notification. Valid values are: disabled, participating, watch, global, mention, custom | `string` | `"custom"` | no |
...
| <a name="input_new_note"></a> [new\_note](#input\_new\_note) | Enable notifications for new notes on merge requests | `bool` | `true` | no |
